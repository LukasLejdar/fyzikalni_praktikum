...
\begin{flalign*}
  ...
  & \text{tlakový spád} & \rho &= 112 \pm 4 \text{ kPa} &
\end{flalign*}
...
\bibitem{tabulky} Kinematická a dynamická viskozita vody ~\url{https://e-konstrukter.cz/prakticka-informace/kinematicka-a-dynamicka-viskozita-vody}.   
\end{thebibliography}
