system("awk '!/^#/ {sum += $1; printf(\"%s\", sum); \
  for (i=2; i<=NF; i++) printf(\" %s\", $i); print \"\"}' nosnik_peta.txt > nosnik_summed.txt")
...
"nosnik_summed.txt" u 1:3 ps 1 lc 0 lt 7 t "odebírání závaží", \
"nosnik_summed.txt" u 1:5 ps 1 lc 0 lt 7 t "", \
"nosnik_summed.txt" u 1:7 ps 1 lc 0 lt 7 t "", \
"nosnik_summed.txt" u 1:9 ps 1 lc 0 lt 7 t "", \
[0:1100] f1(x) lc 1 lt 0 lw 5 t  "hliník", \
[0:1100] f3(x) lc 2 lt 0 lw 5 t  "mosaz", \
...
plot "nosnik_summed.txt" u 1:2 ps 1.1 lc 1 lt 7 t " "

set key at x_legendy - 0.5 * dl,6.7
plot "nosnik_summed.txt" u 1:6 ps 1.1 lc 2 lt 7 t " "

set key at x_legendy + 0.5*dl,6.7
plot "nosnik_summed.txt" u 1:4 ps 1.1 lc 4 lt 7 t " "

set key at x_legendy + 1.5*dl,6.7
plot "nosnik_summed.txt" u 1:8 ps 1.1 lc 5 lt 7 t " "
