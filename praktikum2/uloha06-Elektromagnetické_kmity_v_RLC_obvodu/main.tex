...
%\begin{align*}
%    \hat{U}_1 = U_1 e^{i \omega t} &= \hat{U}_Z + \hat{U}_I \\
%    U_1 e^{i \omega t} &=  (R_R + i \omega L + R_L + \frac{1}{i \omega C} + R_C + R_I) \hat{I} \\
%    U_1 e^{i \omega t} &=  Z e^{ i \varphi_Z } \cdot I e^{i (\omega t - \varphi_Z)} \\
%    U_1 e^{i \omega t} &=  Z I e^{i \omega t},
%\end{align*}
...
\begin{table}[htpb]
    ...
    \begin{tabular}{ll}
        ...
        \resizebox{.45\textwidth}{!}{ \input{resonance_G.tex} } &
        \resizebox{.45\textwidth}{!}{ \input{resonance_phi.tex} } \\
    \end{tabular}
    \vspace{5pt}
...
\begin{table}[htpb]
    ...
    \begin{tabular}{ll}
        ...
        \resizebox{.45\textwidth}{!}{ \input{podkriticke.tex} } &
        \resizebox{.45\textwidth}{!}{ \input{kriticke.tex} } \\
        \\
        c) nadkritické tlumení \\
        \resizebox{.46\textwidth}{!}{ \input{nadkriticke} }
    \end{tabular}
    \vspace{15pt}
